...
- [`faa4b9e`](https://github.com/flatink/flatkit/commit/faa4b9ee71c63c0a006e96465b0210d540a4d661) Thanks [@kaelhem](https://github.com/kaelhem)! - `object"R"` parses like `object "R"` -- the space between a keyword and its literal is nowhere significant.
